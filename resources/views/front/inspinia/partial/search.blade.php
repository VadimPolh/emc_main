<div class="col-lg-12 animated fadeInDown searchbox" style="display: none">
    <div class="ibox float-e-margins">
        <div class="ibox-content search-inner">

            <h2 class="search-title">
                Введите поисковый запрос..
                {{--2,160 results found for: <span class="text-navy">“Admin Theme”</span>--}}
            </h2>
            {{--<small class="search-time">Request time  (0.23 seconds)</small>--}}
