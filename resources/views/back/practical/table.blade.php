@foreach ($practicals as $practical)
    ...
    <tr>
        ...
        <td>{!! link_to_route('practical.show', trans('back/objects.see'), [$practical->id], ['class' => 'btn btn-success btn-block btn']) !!}</td>
        <td>{!! link_to_route('practical.edit', trans('back/objects.edit'), [$practical->id], ['class' => 'btn btn-warning btn-block']) !!}</td>
        <td>
